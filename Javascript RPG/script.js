...
const locations = [
    {
        ...
        text: "You are in the town square. You can visit the store to buy weapon or regenerate you health.You can go to cave or fight with the dragon."
    },
    {
        name: "store",
    ...
    },
    {
        ...
        "button text" : ["REPLAY?","REPLAY?","REPLAY?"],
        "button functions" : [restart,restart,restart],
        text: 'You defeated the dragon and saved the town. Congratulations!'
    },
    {
        name: "easterEgg",
...
function buyHealth(){
    if(gold>=10)
    {
        ...
        text.innerText = "You regenerate 10 hp.";
    }
    else
    text.innerText = "You dont have enough gold to regenerate !";
